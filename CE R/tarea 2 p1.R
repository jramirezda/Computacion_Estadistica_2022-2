...
str(Exportaciones)
?dplyr
#QuÃ© porcentaje del volumen de las exportaciones de cafÃ© en 2018 se hicieron durante el mes de agosto?
mytable(Volumen ~ Mes , data = Exportaciones,subset = c(Ano==2018 & Producto=="CafÃ©"))
# de lo que concluimos que en 2018 el 9.25% del volumen de cafe fue exportado en algosto. 

#QuÃ© porcentaje del volumen de las exportaciones de cafÃ© en 2018 se hicieron durante el primer trimestre del aÃ±o?
mytable(Volumen ~ Mes , data = Exportaciones,subset = c(Ano==2018 & Producto=="CafÃ©"))
# de lo que concluimos que en 2018 el 26.60% del volumen de cafe fue exportado en el primer trimestre.

#QuÃ© porcentaje del valor de las exportaciones de cafÃ© en 2018 se hicieron durante el mes de septiembre?
mytable(Volumen ~ Mes , data = Exportaciones,subset = c(Ano==2018 & Producto=="CafÃ©"))
# de lo que concluimos que en 2018 el 7,82% del volumen de cafe fue exportado en septiembre.

#QuÃ© porcentaje del valor de las exportaciones de cafÃ© en 2018 se hicieron durante el cuarto trimestre del aÃ±o?
mytable(Volumen ~ Mes , data = Exportaciones,subset = c(Ano==2018 & Producto=="CafÃ©"), ord="-levels")
#De lo que concluimos que en 2018 el 26.27% del volumen de cafÃ© exportado fue durante el ultimo trimestre del aÃ±o. 

#QuÃ© porcentaje del volumen de las exportaciones de flores en Antioquia en 2019 se hicieron durante el primer trimestre del aÃ±o?
...
#QuÃ© porcentaje del volumen de las exportaciones de flores durante el primer trimestre del 2019 se hicieron desde Antioquia?
...
#QuÃ© porcentaje del valor de las exportaciones de flores en Antioquia en 2019 se hicieron durante el tercer trimestre del aÃ±o?
...
#QuÃ© porcentaje del valor de las exportaciones de flores durante el tercer trimestre del 2019 se hicieron desde Antioquia?
...
#QuÃ© porcentaje de la cartera (nÃºmero de crÃ©ditos) corresponde a crÃ©ditos "malos"?
#30%

#QuÃ© porcentaje de la cartera (valor de los crÃ©ditos) corresponde a crÃ©ditos "malos"?
mytable(credit_amount~ class,data=credit,ord="freq")  
#36.12% equivalente a 1181438                  

#El porcentaje de la cartera (nÃºmero de crÃ©ditos) que corresponde a crÃ©ditos "malos" es menor para los clientes con "buen" historial crediticio?
...
#El porcentaje de la cartera (en valor) que corresponde a crÃ©ditos "malos" es menor para los clientes con "buen" historial crediticio?
...
#El porcentaje de la cartera (nÃºmero de crÃ©ditos) que corresponde a crÃ©ditos "malos" es menor para los clientes con empleos mÃ¡s estables?
...
#El porcentaje de la cartera (valor de los crÃ©ditos) que corresponde a crÃ©ditos "malos" es menor para los clientes con empleos mÃ¡s estables?
